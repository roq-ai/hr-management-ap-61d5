  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application, where human resources become strategic assets. Experience seamless HR processes and unlock your team's potential."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application, where human resources become strategic assets. Experience seamless HR processes and unlock your team's potential.`}
            </Text>
            <Box
