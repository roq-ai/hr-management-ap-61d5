...
import { useRoqPlatformUserProfiles, useDepartmentCount, useProjectCount, useAttendanceCount } from 'lib/roq';

import { DepartmentListPage as ShowCaseList } from 'pages/departments';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`departments`} passHref legacyBehavior>
                  <Button
